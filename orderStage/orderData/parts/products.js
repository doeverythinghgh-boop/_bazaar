    ...
    orderRender: function (orderData) {
        ...
        if (el && el.style.display !== 'none') {
            ...
            if (contentEl) {
                ...
                // ADMIN ROLES: Have full bypass and view/edit rights across all panels.
                ...
                // SELLER ROLE: Can only edit availability for their own products.
                ...
                const itemsHTML = items.map((item, idx) => {
                    ...
                    // Admin/Super Admin can edit any item.
                    // A Seller can only edit items that match their unique user_key.
                    const canEditThisItem = isSuperAdmin || isAdmin || (isSeller && item.seller_key === user.user_key);
                    ...
                    const showToggle = (isSpecialService === false || !item.serviceType || item.serviceType == 0 || item.serviceType == 1);
