...
function profileGetElements() {
    return {
        ...
        passwordFieldsContainer: document.getElementById("profile-change-password-section"),
        sellerOptionsBtn: document.getElementById("profile-seller-options-btn"),
        isDeliveredInput: document.getElementById("profile-is-delivered"),
        ...
        avatarPickBtn: document.getElementById("profile-avatar-pick-btn"),
        avatarCameraBtn: document.getElementById("profile-avatar-camera-btn"),
        ...
        avatarEditIcon: document.querySelector(".profile-avatar-edit-icon"),
        tabButtons: document.querySelectorAll(".profile-tab-btn"),
        tabContents: document.querySelectorAll(".profile-tab-content"),
        businessTabBtn: document.getElementById("profile-business-tab-btn"),

        // ✅ NEW: Business Fields
        businessName: document.getElementById("profile-business-name"),
        businessCategory: document.getElementById("profile-business-category"),
        businessSubCatsGroup: document.getElementById("profile-business-sub-category-group"),
        businessSubCatsContainer: document.getElementById("profile-business-sub-categories-container"),
        businessBio: document.getElementById("profile-business-bio"),
        businessWhatsapp: document.getElementById("profile-business-whatsapp")
    };
}
