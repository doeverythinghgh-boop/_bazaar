    ...
    try {
        ...
        if (productData) {
            ...
            Swal.fire({
                ...
                text: window.langu("pv_no_product_data") || 'لم يتم العثور على بيانات الخدمة'
            });
        }
