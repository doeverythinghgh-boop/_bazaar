 ...
 * @constant
 * @type {string}
 * @description Storage key used to persist the selected main category for navigation.
 */
var CATEGORIES_MAIN_SELECTION_KEY = 'selectedMainCategory';

/**
 * @description Persist selected main category and navigate to the main-category page.
...
function categories_navigateToMainCategory(category) {
    try {
        ...
        localStorage.setItem(CATEGORIES_MAIN_SELECTION_KEY, JSON.stringify(selectionPayload));

        // Standalone navigation
        window.location.href = '/pages/main-category/main-category.html';
    } catch (error) {
        console.error('%c[categories_navigateToMainCategory] Error:', 'color: red;', error);
    }
}
...
function categories_onMainCategoryClick(event) {
    try {
        ...
        console.error('%c[categories_onMainCategoryClick] Error:', 'color: red;', error);
    }
}
// **********************************************
    ...
    try {
        ...
        viewAllBtn.addEventListener('click', () => {
            ...
            if (searchNavBtn) {
                ...
                // Fallback: direct navigation if button not found
