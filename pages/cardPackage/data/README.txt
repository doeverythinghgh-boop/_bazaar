...
- special_vehicle_factor:
  ...
  التأثير: نسبة مئوية (مثلاً 0.5 = 50%) تُضرب في "تكلفة المسافة"، وتُضاف إذا كان الطلب يحتوي على خدمات تتطلب شاحنة.
...
- office_location:
  موقع المكتب. (lat, lng)
  التأثير: النقطة التي يبدأ منها حساب المسافة لأول مقدم خدمة.
...
- placeholder_image:
  الصورة البديلة.
  التأثير: رابط صورة يظهر للخدمات التي لا تملك صورة خاصة.
