...
function registerGetElements() {
    return {
        ...
        loginLink: document.getElementById("register_goToLoginLink"),
        ...
        // Tabs
        tabBtns: document.querySelectorAll('.register_tab-btn'),
        tabContents: document.querySelectorAll('.register_tab-content'),

        // Business Fields
        businessFieldsContainer: document.getElementById("register_business_fields_container"),
        businessName: document.getElementById("register_business_name"),
        businessCategory: document.getElementById("register_business_category"),
        businessSubImgGroup: document.getElementById("register_business-sub-category-group"), 
        businessSubImgsContainer: document.getElementById("register_business-sub-categories-container"), 
        businessBio: document.getElementById("register_business_bio"),
        businessWhatsapp: document.getElementById("register_business_whatsapp"),

        // Seller Options
        sellerOptionsBtn: document.getElementById("register_seller-options-btn"),
