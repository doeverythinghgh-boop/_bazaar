...
// Discard Button Logic (Bottom and Top)
var edit2_btnDiscard = document.getElementById('edit2_btn_discard');
var edit2_btnDiscardTop = document.getElementById('edit2_btn_discard_top');
...
if (edit2_btnDiscard) edit2_btnDiscard.addEventListener('click', handleDiscardAction);
if (edit2_btnDiscardTop) edit2_btnDiscardTop.addEventListener('click', handleDiscardAction);
