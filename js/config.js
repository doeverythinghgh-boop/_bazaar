...
/**
 * @description The Super Admin Key (God Mode).
 * Grants bypass to all security shields and enables the dev console.
 * @type {string}
 * @const
 */
window.SUPER_ADMIN_KEY = "682dri6b";
 ...
 * @const
 */
const ADMIN_IDS = ["dl14v1k7", window.SUPER_ADMIN_KEY, "pngukw"];
